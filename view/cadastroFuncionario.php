        ...
        <section class="conteudo-cadastro">
            <section class="conteudo-formulario-cadastro">
                <form method="POST" action="../processamento/processamento.php">
                    ...
                    <input type="text" placeholder="Nome" name="inputNome1">
                    <input type="text" placeholder="Sobrenome" name="inputSobrenome1">
                    <input type="text" placeholder="CPF" name="inputCPF1">
                    <input type="date" placeholder="Data Nascimento" name="inputDataNasc1">
                    <input type="text" placeholder="Telefone" name="inputTelefone1">
                    <input type="text" placeholder="Cargo/Função" name="inputcargo1">
                    <input type="text" placeholder="Salário" name="inputSalario1">
                    <input type="email" placeholder="Email" name="inputEmail1">
                    <input type="password" placeholder="Senha" name="inputSenha1">
                    <p>Selecionar foto de perfil:</p>
                    <input type="file" placeholder="file" name="inputfoto">
